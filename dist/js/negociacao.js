...
export class Negociacao {
    ...
    get data() { return __classPrivateFieldGet(this, _Negociacao_data, "f"); }
    get quantidade() { return __classPrivateFieldGet(this, _Negociacao_quantidade, "f"); }
    get valor() { return __classPrivateFieldGet(this, _Negociacao_valor, "f"); }
    get volume() {
